<template>
  <div>
    ...
    <form class="form" @submit.prevent="onSubmit">
      ...
      Features:<br />
      <input type="text" v-model="home.features[0]" class="w-2/6" />
      <input type="text" v-model="home.features[1]" class="w-2/6" />
      <input type="text" v-model="home.features[2]" class="w-2/6" />
      <input type="text" v-model="home.features[3]" class="w-2/6" />
      <input type="text" v-model="home.features[4]" class="w-2/6" /><br />
      Price Per Night:<br />
